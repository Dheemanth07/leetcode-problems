// Last updated: 6/26/2026, 1:03:12 PM
1struct TrieNode {
...
18    // on
19    bool searchHelper(string& word, int index, TrieNode* node) {
20
...
62
63    void addWord(string word) {
64        TrieNode* current = root;
65        for (char c : word) {
66            int index = c - 'a';
67            if (!current->children[index])
